...
export default function About() {
  return (
    <section id="about" className="py-24 lg:px-margin-desktop px-margin-mobile">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-gutter items-center">
          ...
          <Reveal direction="right" delay={80}>
            <div className="lg:pl-12">
              <span className="font-label-caps text-primary mb-4 block">THE DEVELOPER // BIO</span>
              <h2 className="font-headline-lg text-headline-lg uppercase mb-8">Ed Paulo Pedro</h2>
              ...
              <div className="grid grid-cols-2 lg:grid-cols-3 gap-gutter border-t border-primary/20 pt-8">
                ...
                <div>
                  ...
                  <span className="font-label-caps text-[10px] text-primary block mb-2">LEARNED</span>
                </div>
                <div>
                  <h3 className="font-headline-lg text-headline-lg uppercase">
                  ...
                  <span className="font-label-caps text-[10px] text-primary block mb-2">EXPERIENCE</span>
                </div>
              </div>
            </div>
          </Reveal>
