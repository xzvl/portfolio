      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-px bg-primary/20 border border-primary/20">
        {services.map((service) => (
          <div
            ...
            className="bg-black p-6 py-12 lg:p-12 relative overflow-hidden group"
          >
            <div className="absolute top-0 left-0 w-1 h-full bg-primary opacity-0 group-hover:opacity-100 transition-opacity" />
            <span className="font-code-sm text-primary block mb-8">
              {service.number}
            </span>
            <h3 className="font-headline-lg text-headline-lg uppercase mb-6">
              {service.title}
            </h3>
            <p className="font-body-md text-on-secondary-container mb-8">
              {service.description}
            </p>
