    ...
    <section id="contact" className="bg-surface-container-lowest border-t-2 border-primary/20">
      <div className="flex flex-col lg:flex-row">
        ...
        <Reveal direction="left" className="lg:w-1/3">
          <div className="lg:p-margin-desktop py-24 bg-black flex flex-col justify-between border-r-2 border-primary/10 px-margin-mobile h-full">
            <div>
              ...
              <p className="font-body-md text-on-surface-variant mb-12">
                Ready to architect your next digital system? Reach out for collaboration or inquiries.
              </p>
              <div className="space-y-6">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <a className="font-code-sm hover:text-primary transition-colors" href="tel:+639957118740">
                    +63 995 711 8740
                  </a>
                </div>
                <div className="flex items-center gap-4">
        ...
        {/* Form panel — slides from right */}
        <Reveal direction="right" delay={80} className="lg:w-2/3">
          <div className="lg:p-margin-desktop px-margin-mobile py-24">
            <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-gutter">
              <div className="col-span-1">
                <label className="font-label-caps text-[10px] text-primary mb-2 block">IDENTIFIER (NAME)</label>
                <input
              ...
              <div className="col-span-1">
                <label className="font-label-caps text-[10px] text-primary mb-2 block">TRANSMISSION_POINT (EMAIL)</label>
                <input
                  className="w-full bg-surface-container-high border-2 border-primary/20 text-on-surface px-6 py-4 focus:border-primary outline-none transition-colors rounded-none font-code-sm"
              ...
              <div className="col-span-full">
                <label className="font-label-caps text-[10px] text-primary mb-2 block">DATA_PACKET (MESSAGE)</label>
                <textarea
              ...
              <div className="col-span-full flex items-center justify-between gap-4 flex-wrap">
                {status === "success" && (
                  <span className="font-code-sm text-primary">TRANSMISSION_SENT // MESSAGE RECEIVED</span>
                )}
                {status === "error" && (
                  <span className="font-code-sm text-error">ERROR // FAILED TO TRANSMIT. RETRY.</span>
                )}
